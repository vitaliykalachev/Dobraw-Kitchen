...
class Recipe(Base):
    ...
    title = Column(String, index=True)
    description = Column(String, index=True)
    # ingredients = relationship("IngredientPartRecipe", back_populates="ingredient")
...
class Ingredient(Base):
    ...
    recipe_ingredient = relationship("RecipePart",  back_populates="ingredient")
...
class IngredientPartRecipe(Base):
    ...
    # ingredient = relationship("Ingredient", back_populates="recipe_part")
